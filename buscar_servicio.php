...
if(isset($_POST['submit'])){
    ...
    header("Location: consultar_servicio.php?id_cliente=".$id_cliente);
    exit;
}
...
<body>
	...
	<div class="container">
		<div class="form-container">
			<h2 class="mb-4">Buscar Servicio</h2>
			<form method="POST" action="">
    			<div class="form-group form-row">
    				<label class="col-sm-3" for="id_cliente">Servicio</label>
    				<div class="col-sm-9">
    				    <select class="form-control" id="id_cliente" name="id_cliente">
                            <option value="">Selecciona un servicio</option>
                            <?php
                                // Consulta para obtener los clientes
                                $consulta_clientes = "SELECT id, nombre FROM servicios";
