...
<body>
	...
	<div class="container">
		<div class="form-container">
			...
			<form method="POST" action="">
				...
				<div class="centrar">
				    <button type="submit" name="submit" class="btn btn-primary">Registrar Cliente</button>
				</div>
			</form>
		</div>
	</div>
	...
	if(isset($_POST['submit'])){
	  ...
	  $consulta = "INSERT INTO clientes (nombre, direccion, telefono, email) VALUES ('$nombre', '$direccion', '$telefono', '$email')";
