...
while($fila_cliente = mysqli_fetch_assoc($resultado_clientes)){
        ...
        $direccion = $fila_cliente['direccion'];
    }
?>
...
<body>
	...
	<div class="container">
		<div class="form-container">
			...
			<form>
				...
				<div class="form-group form-row">
					<label class="col-sm-3" for="cliente">Direccion:</label>
					<div class="col-sm-9">
				...
				<div>
					...
					<table id="mi_tabla">
                		...
                		<tbody>
                		    <?php
                		    $consulta_servicios = "SELECT s.nombre AS servicio, cs.precio AS precio 
    ...
    <script>
        document.getElementById("enviar").addEventListener("click", function() {
            window.location.href = "buscar_cliente.php";
        });
    </script>
</body>
</html>