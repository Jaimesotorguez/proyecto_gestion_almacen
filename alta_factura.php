...
$consulta = "SELECT nombre FROM clientes WHERE id = ".$id_cliente;
	...
	<div class="container">
		<div class="form-container">
				...
				<form method="post">
			        ...
			        <div class="form-group form-row">
					    <label class="col-sm-3" for="numero_factura">Numero factura:</label>
					    <div class="col-sm-9">
			                <input class="form-control" type="text" id="numero_factura">
			            </div>
			        </div>
                    ...
                    $(document).ready(function() {
                      ...
                      $('#guardar_pedido').click(function() {
                          ...
                          if (!cliente || !factura || !fecha || num_pedidos == 0) {
                          ...
                          $.ajax({
                            url: 'guardar_pedido_facturado.php',
                            method: 'POST',
                            data: {
                              cliente: cliente,
                              factura: factura,
                    	...
                    	<div class="col-sm-9">
                    		<select class="form-control" id="pedido" name="pedido">
                    			...
                    			<?php
                                  ...
                                  $consulta = "SELECT id, n_pedido FROM pedidos WHERE id NOT IN (SELECT id_pedido FROM pedido_facturado) AND id_cliente = ".$id_cliente;
                                  $resultado = mysqli_query($conexion, $consulta);
					...
					<div class="button-container">
                      <button class="btn btn-primary" type="button" name="submit" id="guardar_pedido">Guardar</button>
                    </div>
				</form>
		</div>
    </div>
