...
<body>
    ...
    <script>
        ...
        $(document).ready(function() {
                ...
                $.ajax({
                  url: 'obtener_ids_precios.php',
                  method: 'GET',
                  
                  success: function(response) {
                    // Parsear la respuesta JSON
                    
                    var precios = JSON.parse(response);
                    // Crear una nueva fila para la tabla
                    
                    precios.forEach(function(precio) {
                        var fila = '<tr>' +
                            '<td>' + precio.nombre_cliente + '</td>' +
                            '<td>' + precio.nombre_servicio + '</td>' +
                            '<td>' + precio.precio + '</td>' +
                ...
                $('table tbody').on('click', 'button', function() {
                    ...
                    window.location.href = 'https://logisticstrack.es/consultar_precio.php?id_cliente=' + valor;
                });
        });
